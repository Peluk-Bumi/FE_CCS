  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-bold text-blue-900 dark:text-blue-100">Konteks Proyek:</h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-2 rounded bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-900/60 transition-colors text-sm font-medium"
        >
        ...
        >
          <div className="space-y-4 text-sm leading-7 text-gray-700 dark:text-gray-300 pt-2">
            <p>
