  ...
  const testimonials = [
    {
      ...
      company: "Komunitas Pesisir Utara",
      content: "Proses dokumentasi yang terbuka membantu kami memahami perkembangan aktivitas konservasi di wilayah kami. Setiap langkah dapat dipelajari bersama.",
      avatar: FiUser,
      rating: 5,
    ...
    },
    {
      ...
      company: "Universitas Nasional",
      content: "Pendekatan berbasis proses dan transparansi data memberikan kami kepercayaan untuk terlibat dalam gerakan konservasi ini.",
      avatar: FiUser,
      rating: 5,
      image: "/images/login-bg.jpg"
    },
    {
      ...
      company: "Relawan Mangrove Indonesia",
      content: "Sistem monitoring yang sedang dikembangkan ini membantu kami melihat dampak nyata dari setiap aksi konservasi yang kami lakukan.",
      avatar: FiUser,
      rating: 5,
      image: "/images/login-bg.jpg"
    }
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-amber-700">Cerita Kolaborator</span>
          </motion.div>
          ...
          <p className={`text-lg md:text-xl max-w-3xl mx-auto transition-colors ${
            ...
            Bergabunglah dengan <span className="font-bold text-primary">kolaborator</span> yang terlibat dalam proses konservasi berbasis dokumentasi
          </p>
        </motion.div>
