...
export default function PlanningListPage() {
  ...
  // Planning tabs from navigationConfig
  const planningTabs = navigationConfig.getPlanningMenuItems(isAdmin);
  ...
  return (
    <div className="space-y-6 py-6 md:py-8">
      ...
      {/* Sub-navigation tabs — visible on mobile only, sidebar handles desktop */}
      <div className="md:hidden mb-4">
        <PageTabs tabs={planningTabs} />
      </div>
