      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        <div className="w-full rounded-3xl border border-white/15 dark:border-primary/10 bg-white/10 dark:bg-green-950/25 backdrop-blur-xl shadow-[0_24px_60px_-32px_rgba(81,118,64,0.45)] p-5 sm:p-6 lg:p-7 overflow-hidden">
          ...
          >
            ...
            >
              <span>Revolusi</span>{" "}
              <span className="bg-gradient-to-r from-primary to-primary-dark dark:from-primary dark:to-primary-dark bg-clip-text text-transparent">
                Konservasi Digital
              </span>{" "}
              <motion.span
              ...
              >
                <FiGlobe className="w-10 h-10 md:w-14 md:h-14 text-primary" />
              </motion.span>
            </motion.h1>
            ...
            >
              ...
              <span className="font-semibold text-primary dark:text-primary-light">teknologi blockchain</span>,{" "}
                    ...
                    <div className="grid grid-cols-3 gap-4">
                                            {[
                                              ...
                                              >
                                                ...
                                                <div className="text-xs text-primary-light">{stat.label}</div>
                                              </motion.div>
                                            ))}
                                          </div>
                  </div>
